...
class Trainer:
    ...
    def __init__(
        ...
        self.label_names = ["labels"] if not self.label_names else self.label_names # todo manually add labels
    ...
    def _wrap_model(self, model, training=True, dataloader=None):
        ...
        device_ids = [int(did) for did in self.args.device_ids.split(' ')]
        ...
        # Distributed training using PyTorch FSDP
            ...
            # )
            model = nn.parallel.DistributedDataParallel(model, device_ids=[dist.get_local_rank()], broadcast_buffers=False)
