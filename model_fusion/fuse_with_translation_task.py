import sys
sys.path = ['/user/sunsiqi/hs/ModelFusion/otfusion'] + sys.path
import otfusion.utils_zz2 as uz2
import otfusion.activation_utils as au
import otfusion.prepare as prepare
import copy


if __name__ == '__main__':
    import otfusion.deberta_prepare as dprepare
    exp=sys.argv[1]
    ...
    # 不对embedding层和layernor_embedding做融合 todo ignoring embedding layer and layernorm_embedding layer
