...
sys.path = ['/user/sunsiqi/hs/MoE', '/user/sunsiqi/hs/MoE/transformers',
            ...
            '/user/sunsiqi/openfold/lib/conda/envs/ddg/lib/python38.zip', '/user/sunsiqi/openfold/lib/conda/envs/ddg/lib/python3.8',
...
def main():
    ...
    if data_args.task_name is not None:
        ...
        if data_args.train_file.endswith(".csv") or data_args.train_file.endswith(".tsv"):
            ...
            datasets = load_dataset("csv", data_files=data_files, cache_dir=model_args.cache_dir, **{'sep':'\t', 'header':None})
        else:
    ...
    if training_args.do_eval:
        ...
        for eval_dataset, task in zip(eval_datasets, tasks):
            ...
            if training_args.resume_from_checkpoint is not None:
                ...
                checkpoint = last_checkpoint
            metrics = trainer.evaluate(eval_dataset=eval_dataset, resume_from_checkpoint=checkpoint)
