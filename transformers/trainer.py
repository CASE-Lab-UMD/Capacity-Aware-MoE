...
if is_apex_available():
    from apex import amp # bug emerges sometimes
...
class Trainer:
    ...
    def train(
        ...
        **kwargs,
        ...
        #todo deal with the multi-experts
    ...
    def _load_state_dict_in_model(self, state_dict):
        ...
        if len(load_result.missing_keys) != 0:
            if not self.model._keys_to_ignore_on_save or set(load_result.missing_keys) == set(self.model._keys_to_ignore_on_save):
    ...
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        # outputs["generate"] = model.module.generate(**inputs)
            ...
            if is_sagemaker_mp_enabled():
                ...
                if has_labels:
                    ...
                    if 'moe_loss' in outputs and outputs['moe_loss'] is not None:
                        loss -= outputs['moe_loss']
                        ignore_keys.append('moe_loss')
